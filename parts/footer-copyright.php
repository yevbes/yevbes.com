<footer class="container-fluid footer-bottom-section-design noselect">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <p>Copyright © 2017 -
                    <?php echo date("Y"); ?> | <a href="#">www.yevbes.com</a> | <a href="#">Cookies policy</a> | { made
                    with <span class="heartFooter">&hearts;</span> by <a href="../resume.php">yevbes</a> }</p>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="social-icons-design">
                    <svg class="soc-ico-design" width="40px" height="40px" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 800 800">
